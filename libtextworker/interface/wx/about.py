...
class AboutDialog:
    ...
    def SetLicense(self, license: str):
        ...
        if license not in available_licenses:
            raise libTewException("Sorry about this, but we couldn't find any license as requested ({}). You should notify this for libtextworker devs".format(license))
        targetfile = CraftItems(GetCurrentDir(__file__), "../../licenses/{}.txt".format(license))
